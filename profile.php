...
<head>
	...
	<script>
	function form_validation(mobileno, fullname, age) {
    var valid = true;
    var mobile_pattern = /^[0-9]{10}$/; // regular expression for mobile number pattern
    var age =document.getElementById("age").value;
	
    if (mobileno.value.trim() == "" || !mobile_pattern.test(mobileno.value.trim())) {
		...
		<div class="py-xl-5 py-lg-3">
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					...
					<form action="#" method="post" onsubmit="return form_validation(document.getElementById('mobileno'), document.getElementById('fullname'), document.getElementById('age'));">
						<?php
$uid=$_SESSION['bbdmsdid'];
...
{               ?>
						<div class="form-group">
							...
							<input type="text" class="form-control" name="fullname" required id="fullname" value="<?php  echo $row->FullName;?>">
						</div>
						<div class="form-group">
