...
<script>
	function form_validation(mobileno, fullname,) {
    var valid = true;
...
<body>
 ...
 <div class="login px-4 mx-auto mw-100">
                            ...
                            <form action="#" method="post"  name="signup" onsubmit="return form_validation(document.getElementById('mobileno'), document.getElementById('fullname'), document.getElementById('age'));">
...
<?php }} ?>
                                ...
                                <button type="submit" class="btn btn-primary submit mb-4" name="submit">Register</button>
                                 ...
                                 <p class="account-w3ls text-center pb-4" style="color:#000">
                                   Already Registered?
                                    <a href="login.php" >Signing now</a>
                                </p>
                            </form>
                        </div>
